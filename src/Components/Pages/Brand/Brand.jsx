...
import BrandPrint from "./BrandPrint";
...
const Brand = () => {
  ...
  const { data, isLoading, isError, error } = useGetBrandsByPaginationQuery({
    page: paginationPage,
    limit: limit,
    order: order,
    search: search,
    ...
    <div>
      ...
      {!isLoading && !isError && data && (
        <CustomPaginationTable
          ...
          editPath="/store/dashboard/brand"
      ...
      {
        printButtonClick && <BrandPrint setPrintButtonClick={setPrintButtonClick} newColumns={columns} store_id={store_id} />
      }
      {pdfButtonClick && <BrandPdf setPdfButtonClick={setPdfButtonClick} newColumns={columns} store_id={store_id} />}
    </div>
  );
};
