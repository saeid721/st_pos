...
import { useCreateUnitsMutation, useUpdateUnitsMutation } from "../../../store/api/app/Unit/unitApiSlice";

const UnitForm = ({ id, data }) => {
  ...
  const {
    ...
    id,
    id ? useUpdateUnitsMutation : useCreateUnitsMutation
  );
