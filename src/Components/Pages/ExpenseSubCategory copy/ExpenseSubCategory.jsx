...
import { useGetExpenseSubCategoryByPaginationQuery } from "../../../store/api/app/ExpenseSubCategory/expenseCategoriesApiSlice";
...
const ExpenseSubCategory = () => {
  ...
  const { data, isLoading, isError, error } = useGetExpenseSubCategoryByPaginationQuery({
    page: paginationPage,
    limit: limit,
    order: order,
    // search: search,
