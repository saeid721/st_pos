...
const SuperAdmin = () => {
  ...
  const { data, isLoading, isError, error } = useGetSuperAdminsByPaginationQuery({
    page: paginationPage,
    limit: limit,
    order: order,
    // search: search,
  ...
  return (
    <div>
      ...
      {/* <SuperAdminView isOpen={isModalOpen} onClose={handleCloseModal} data={selectedData} title="Users" /> */}
    </div>
  );
};
