...
import { useCreateAssetTypesMutation, useUpdateAssetTypesMutation } from "../../../store/api/app/AssetTypesApi/featuresApiSlice";

const AssetTypesForm = ({ id, data }) => {
  ...
  const {
    ...
    id,
    id ? useUpdateAssetTypesMutation : useCreateAssetTypesMutation
  );
