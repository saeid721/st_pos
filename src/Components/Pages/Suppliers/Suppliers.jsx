...
import SuppliersPrint from "./SuppliersPrint";
import SuppliersPdf from "./SuppliersPdf";
...
const Suppliers = () => {
  ...
  const { data, isLoading, isError, error } = useGetSuppliersByPaginationQuery({
    page: paginationPage,
    limit: limit,
    order: order,
    // search: search,
    ...
    <div>
      ...
      {!isLoading && !isError && data && (
        <CustomPaginationTable
          ...
          editPath="/store/dashboard/suppliers"
      ...
      {
        printButtonClick && <SuppliersPrint setPrintButtonClick={setPrintButtonClick} newColumns={columns} store_id={store_id} />
      }
      {
        pdfButtonClick && <SuppliersPdf setPdfButtonClick={setPdfButtonClick} newColumns={columns} store_id={store_id} />
      }
