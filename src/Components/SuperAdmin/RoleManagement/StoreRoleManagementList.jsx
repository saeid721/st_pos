...
import StoreRoleManagementSettings from "./StoreRoleManagementSettings";
import { useGetRolesStoreQuery } from "../../../store/api/app/Roles/rolesStoreApiSlice";

const StoreRoleManagementList = () => {
  const { data, isError, isLoading } = useGetRolesStoreQuery();
  ...
  return (
    <div className="grid md:grid-cols-4 gap-5">
      ...
      <div className="md:col-span-3">
        <StoreRoleManagementSettings clickedRoleId={clickedRoleId} />
      </div>
    </div>
  );
};

export default StoreRoleManagementList;
